...
class BaseTaintTracker(ABC):
    ...
    def track(self, code_lines):
        """
        Glavna metoda, ki prebere vse vrstice in vrne slovar:
        line_number -> mnozica umazanih (tainted) spremenljivk, ki so na tej vrstici vidne.
        """
        taint_by_line = {}
        current_tainted = set()
        ...
        for code_line in code_lines:
            ...
            # Če naletimo na definicijo funkcije, resetiramo trenutne umazane spremenljivke,
